      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/80 border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <button
            ...
            className="ml-4 rounded-2xl px-4 py-2 text-sm bg-black text-white hover:opacity-90"
          >
            Register Interest
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <ul className="mt-5 space-y-2 text-gray-700">
              ...
              <li>• Steps to Dr. Phillips Center, Lake Eola, Amway Center</li>
            </ul>
          </div>
      ...
      <section id="location" className="bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <p className="mt-3 text-gray-700 max-w-3xl">
            Centrally located in the heart of Downtown Orlando with dining,
            arts, and major venues just outside your door.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-gray-700">
              Be among the first to receive floor plans, pricing, and release
              timing.
            </p>
          </div>
          <div>
            {status === "success" ? (
              <div className="rounded-2xl border p-6 bg-green-50">
                ...
                <p className="mt-2 text-gray-700">
                  You're on the list. We'll follow up with details shortly.
                </p>
                <button
                  onClick={() => setStatus("idle")}
                  className="mt-4 rounded-2xl px-4 py-2 border"
                >
                  Add another
                </button>
              </div>
              ...
              <form
                ...
                className="rounded-2xl border p-6 grid grid-cols-1 gap-4"
              >
      ...
      <footer className="border-t">
        <div className="max-w-6xl mx-auto px-4 py-8 text-sm text-gray-600">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              © {new Date().getFullYear()} {PROJECT.broker.team}. All rights
              reserved. Fair Housing & Equal Opportunity.
            </div>
            <div className="flex gap-6">
              ...
              <a
                href={`mailto:${PROJECT.broker.email}`}
